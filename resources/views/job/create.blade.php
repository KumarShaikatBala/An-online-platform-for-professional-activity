...
@section('content')
    ...
    {!! Form::open(['route' =>'job-post-store','class'=>'','method' => 'post','enctype'=>'multipart/form-data']) !!}
    {{ csrf_field() }}
    <!-- Page header -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6">
                    <input type="text" name="tittle" class="form-control input-lg" placeholder="Job title, e.g. Front-end developer">
                </div>
                ...
                <div class="form-group col-xs-12">
                    <input type="text" name="url" class="form-control" placeholder="Application URL">
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="hours" class="form-control" placeholder="Working hours, e.g. 40">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="experience" class="form-control" placeholder="Experience, e.g. 5">
