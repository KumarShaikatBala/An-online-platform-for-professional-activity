                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 col-lg-10">
                                <div class="form-group">
                                    <input type="text" name="company_name" class="form-control input-lg" placeholder="Comapny name">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="company_heading" class="form-control" placeholder="Headline (e.g. Internet and computer software)">
                                </div>

                                <div class="form-group">
                                    <textarea class="form-control" rows="3" placeholder="Short description" name="company_description"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="company_website" class="form-control" placeholder="Website address">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="company_foundation" class="form-control" placeholder="Founded on, e.g. 2013">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="company_mobile" class="form-control" placeholder="Phone number">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="company_email" class="form-control" placeholder="Email address">
                                </div>
                            </div>
        ...
        <main>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="dribbble" class="form-control" placeholder="Profile URL">
                                </div>
                            </div>
            ...
            <section class=" bg-alt">
                <div class="container">
                    ...
                    <textarea class="summernote-editor" name="company_details"></textarea>
            ...
            <section>
                <div class="container">
                    ...
                    <p class="text-center"><button class="btn btn-success btn-xl btn-round" type="submit">Submit your company</button></p>
